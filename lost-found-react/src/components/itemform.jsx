...
//   className="inline-block px-[15px] py-[10px] bg-white text-blue-900 text-base border-[2.5px] border-[rgb(145,140,172)] rounded-lg cursor-pointer text-center hover:bg-blue-900 hover:text-white transition-colors duration-300">
//   Upload Image
// </label>
