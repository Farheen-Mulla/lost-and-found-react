    ...
    return (
        <div className="p-4 bg-[#b4cbf0] h-[30rem] overflow-y-auto w-[50rem] border-4 border-[#1e3985] rounded-lg">
            ...
            {items.map((item, index) => (
                <div key={index} className="relative min-h-[6rem] w-full bg-white p-4 rounded-lg shadow-[0_2px_6px_rgba(0,0,0,0.35)] my-4 flex flex-col"> 
                    ...
                    {item.img && (
                        <img src={URL.createObjectURL(item.img)} className="w-[150px] h-[150px] object-cover rounded-lg mb-2" />
                    )}
